...
def calculate_scenario(one_off_pension, one_off_isa_y1, one_off_isa_y2, annual_isa):
    ...
    tax_paid = calculate_tax(total_income - one_off_pension)
    ni_paid = calculate_ni(total_income - one_off_pension)
    balance_after_tax = total_income - one_off_pension - tax_paid - ni_paid
    ...
    return pension_value, isa_value, annual_post_tax_income, monthly_post_tax_income, annual_pension_income, annual_isa_income

# --- COMPUTE RESULTS ---
pension_s1, isa_s1, annual_income_s1, monthly_income_s1, pension_income_s1, isa_income_s1 = calculate_scenario(one_off_pension_s1, one_off_isa_s1_y1, one_off_isa_s1_y2, annual_isa_s1)
pension_s2, isa_s2, annual_income_s2, monthly_income_s2, pension_income_s2, isa_income_s2 = calculate_scenario(one_off_pension_s2, one_off_isa_s2_y1, one_off_isa_s2_y2, annual_isa_s2)
...
st.sidebar.success("✅ Adjust inputs & see real-time recommendations!")
